...
export const CustomContacts = ({ onSuccess }: Props) => {
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormControl>
											<Input
												className={`h-[45px] rounded-none border-[#c7c7c7] ${errors.email ? 'border-red-500' : ''}`}
												type='email'
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormControl>
											<Input
												className={`h-[45px] rounded-none border-[#c7c7c7] ${errors.name ? 'border-red-500' : ''}`}
												type='text'
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormControl>
											<Textarea
												className={`h-[100px] rounded-none border-[#c7c7c7] ${errors.comment ? 'border-red-500' : ''}`}
